...
namespace UniversalSystemCenter.Data.UnitOfWorks.SqlServer {
    /// <summary>
    /// 工作单元
    /// </summary>
    public class UniversalSysCenterUnitOfWork : Util.Datas.Ef.SqlServer.UnitOfWork,IUniversalSysCenterUnitOfWork {
        /// <summary>
        /// 初始化工作单元
        /// </summary>
